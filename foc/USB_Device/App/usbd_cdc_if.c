...
extern uint8_t vofaCmdBuf[1024];
...
static int8_t CDC_Receive_FS(uint8_t* Buf, uint32_t *Len)
{
  /* USER CODE BEGIN 6 */
    ...
    else if (strstr(vofaCmdBuf, "iqkp="))
    {
        ...
        motor1.iqPid.ka = motor1.idPid.ki / motor1.iqPid.kp;
        motor1.idPid.ka = motor1.idPid.ki / motor1.idPid.kp;
    }
    ...
    else if (strstr(vofaCmdBuf, "velkp="))
    {
        ...
        motor1.speedPid.ka = motor1.speedPid.ki / motor1.speedPid.kp;
        motor1.speedPid.ka = motor1.speedPid.ki / motor1.speedPid.kp;
    }
    ...
    else if (strstr(vofaCmdBuf, "pll_kp="))
    {
        float val = vofa_cmd_parse(vofaCmdBuf, "pll_kp=");
        motor1.speedPll.pid.kp = val;
    }
    else
    {
    }
